...
public class KafkaBridgeTestConfiguration {
    ...
    @Bean
    public OutboxToKafkaEventBridge outboxToKafkaEventBridge(
            OutboxEventBus outboxEventBus,
            ReactiveKafkaProducerTemplate<String, String> bridgeKafkaProducerTemplate,
            ObjectMapper objectMapper) {
        return new OutboxToKafkaEventBridge(outboxEventBus, bridgeKafkaProducerTemplate, objectMapper, TEST_TOPIC);
    }
